            ...
            <div className="relative m-4 w-4/5 lg:w-2/5  max-w-lg lg:max-w-md rounded-lg bc-surface-dim text-text p-4 shadow-sm">
                ...
                <div className="flex shrink-0 flex-wrap items-center justify-end pt-4">
                    <button onClick={cancelAction}
                        className="rounded-md border border-transparent px-4 py-2 text-center text-sm  transition-all hover:bg-slate-100 focus:bg-slate-100 active:bg-slate-100 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="button">
                        Cancel
                    </button>
                    <button onClick={confirmAction}
                        className="ml-2 rounded-md border border-transparent bg-green-600 px-4 py-2 text-center text-sm  shadow-md transition-all hover:bg-green-700 hover:shadow-lg focus:bg-green-700 focus:shadow-none active:bg-green-700 active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="button">
                        Confirm
                    </button>
                </div>
